...
public class editWordFrame extends JDialog {
    ...
    public editWordFrame(Frame parent, String word, String meaning, String pronounce, int index) {
        ...
        inputPronouce.setText(pronounce);
        inputMeaning.setText(meaning);
        ...
        btnConfirm.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                if (inputWord.getText().equals("") || inputPronouce.getText().equals("")
                    ...
                    int re = controller.updateWord(index, inputWord.getText(), inputPronouce.getText(),
